...
var css_248z = ".selector {\r\n  width: 100%;\r\n  height: 100%;\r\n}\r\n  .selector .box {\r\n    width: 100%;\r\n    height: 100%;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n    z-index: 10000000;\r\n    color: #6b6b6b;\r\n  }\r\n  .selector .box .box-list {\r\n      width: 100%;\r\n      height: 100%;\r\n      position: relative;\r\n    }\r\n  .selector .box .box-list .cover-layer-top,\r\n      .selector .box .box-list .cover-layer-bottom {\r\n        pointer-events: none;\r\n        width: 100%;\r\n        position: absolute;\r\n        left: 0;\r\n        height: calc(50% - 15px);\r\n        z-index: 100000000;\r\n      }\r\n  .selector .box .box-list .cover-layer-top {\r\n        top: 0;\r\n        border-bottom: 1px solid var(--adm-border-color);\r\n        background: linear-gradient(0deg, hsla(0, 0%, 100%, 0.7) 0%, #fff);\r\n      }\r\n  .selector .box .box-list .cover-layer-bottom {\r\n        bottom: 0;\r\n        border-top: 1px solid var(--adm-border-color);\r\n        background: linear-gradient(180deg, hsla(0, 0%, 100%, 0.7) 0%, #fff);\r\n      }\r\n  .selector .box .box-list .box-list-items {\r\n        width: 100%;\r\n        position: absolute;\r\n        margin: auto;\r\n        top: 0;\r\n        left: 0;\r\n        top: calc(50% - 15px);\r\n        cursor: pointer;\r\n        transition: transform 0.3s cubic-bezier(0.7, 0.3, 0.1, 1),\r\n          box-shadow 0.3s cubic-bezier(0.7, 0.3, 0.1, 1);\r\n        transition-delay: 0s, 0s;\r\n        transition-timing-function: cubic-bezier(0.7, 0.3, 0.1, 1),\r\n          cubic-bezier(0.7, 0.3, 0.1, 1);\r\n        transition-duration: 0.3s, 0.3s;\r\n        transition-property: transform, box-shadow;\r\n      }\r\n  .selector .box .box-list .box-list-items span {\r\n          display: flex;\r\n          font-size: 16px;\r\n          transition: transform 0.3s cubic-bezier(0.7, 0.3, 0.1, 1),\r\n            box-shadow 0.3s cubic-bezier(0.7, 0.3, 0.1, 1);\r\n          transition-delay: 0s, 0s;\r\n          transition-timing-function: cubic-bezier(0.7, 0.3, 0.1, 1),\r\n            cubic-bezier(0.7, 0.3, 0.1, 1);\r\n          transition-duration: 0.3s, 0.3s;\r\n          transition-property: transform, box-shadow;\r\n          justify-content: center;\r\n          align-items: center;\r\n        }\r\n";
...
var TabSwitch = function TabSwitch(_ref) {
  var _ref$defaults = _ref.defaults,
      ...
      selectedKey = _ref$selectedKey === void 0 ? function () {} : _ref$selectedKey,
      _ref$inclination = _ref.inclination,
      inclination = _ref$inclination === void 0 ? 5 : _ref$inclination,
      ...
      transparency = _ref$transparency === void 0 ? null : _ref$transparency,
      _ref$blurLayer = _ref.blurLayer,
      blurLayer = _ref$blurLayer === void 0 ? null : _ref$blurLayer,
      _ref$setSelectedKey = _ref.setSelectedKey,
      setSelectedKey = _ref$setSelectedKey === void 0 ? null : _ref$setSelectedKey,
      _ref$gradientSpeed = _ref.gradientSpeed,
      gradientSpeed = _ref$gradientSpeed === void 0 ? 0.03 : _ref$gradientSpeed,
      _ref$alignItems = _ref.alignItems,
      alignItems = _ref$alignItems === void 0 ? 'center' : _ref$alignItems;
  var box = react.useRef();
  ...
  var intervalsY = function intervalsY(item) {
    // 渐变显示
    var opacityKeyY = 0;
  ...
  var intervalsN = function intervalsN(item) {
    // 渐变隐藏
    var opacityKeyN = 1;
    var intervalItem = setInterval(function () {
      if (opacityKeyN <= 0) {
  ...
  var selector = function selector(e, key, value) {
    ...
    var id = Number(box.current.id || 0);
    var selectorTop = Number(box.current.index || 0);
    var multiple = Math.abs(key - id);
    var dom = box.current.children;
    ...
    if (transparency !== null) {
      ...
      for (var _e = key - 1; _e >= 0; _e--) {
        topId += transparency; // topId = Math.round(topId * 10) / 10;

        if (topId > 1) {
          topId = 1;
          dom[_e].style.pointerEvents = 'none';
        } else {
          dom[_e].style.pointerEvents = 'all';
        }

        dom[_e].style.opacity = 1 - topId;
      }

      var efficientLength = dom.length;

      for (var _e2 = key; _e2 < efficientLength; _e2++) {
        // bottomId = Math.round(bottomId * 10) / 10;
        if (bottomId > 1) {
          bottomId = 1;
          dom[_e2].style.pointerEvents = 'none';
        } else {
          dom[_e2].style.pointerEvents = 'all';
        }

        dom[_e2].style.opacity = 1 - bottomId;
    ...
    if (key > id) {
      ...
      box.current.style.transform = "translate3d(0px, ".concat(-selectorTop, "px, 0px)");
    }
    ...
    for (var i = 0; i < dom.length; i++) {
      if (key === i) {
        dom[i].style.transform = "translate3d(".concat(0, "px, 0px, 0px)");
      ...
      if (i < key) {
        ...
        dom[i].style.transform = "translate3d(".concat(Math.pow(key - i, 2) * inclination, "px, 0px, 0px)");
      } else {
        if (setSelectedKey !== null) {
          if (i - key === 1 && key < id) {
            intervalsN(dom[i]); // 隐藏渐变
        ...
        dom[i].style.transform = "translate3d(".concat(Math.pow(i - key, 2) * inclination, "px, 0px, 0px)");
      }
    }
  ...
  return jsx("div", {
    ...
    style: {
      height: "calc(50% - ".concat(itemHeight, "px)"),
      borderBottom: "".concat(borderColor)
    }
  }), jsx("div", {
    ref: box,
    className: "box-list-items",
    style: {
      top: "calc(50% - ".concat(itemHeight, "px)"),
      pointerEvents: "".concat(setSelectedKey !== null ? 'none' : 'all')
    }
  }, dataList.map(function (item, index) {
    return jsx("span", {
      key: item.key,
      onClick: function onClick(e) {
        return selector(e, index, item.content);
      },
      style: {
        transform: "translate3d(".concat(inclination * Math.pow(index, 2), "px, 0px, 0px)"),
        top: "calc(50% - ".concat(itemHeight, "px)"),
        height: "".concat(itemHeight * 2, "px"),
        justifyContent: "".concat(alignItems)
      }
    }, item.content);
  })), blurLayer && jsx("div", {
    ...
    style: {
      height: "calc(50% - ".concat(itemHeight, "px)"),
      borderTop: "".concat(borderColor)
    }
  }))));
};

var TabSwitchPage = TabSwitch;

exports.TabSwitch = TabSwitch;
exports.TabSwitchPage = TabSwitchPage;
