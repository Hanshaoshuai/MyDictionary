...
var index = 0; // 当前的  用于记录上一次的路由  如果是返回条件要 赋值给previous的

var newDom = null; // 当前dom；

var ReactTransitionGroup = function ReactTransitionGroup(_ref) {
  var path = _ref.path,
      component = _ref.component;

  var _useState = react.useState([]),
      _useState2 = _slicedToArray(_useState, 2),
      pathNameList = _useState2[0],
      setPathNameList = _useState2[1]; // 上一个


  var _useState3 = react.useState(null),
      _useState4 = _slicedToArray(_useState3, 2),
      states = _useState4[0],
      setStates = _useState4[1]; // 判断返回还是下一个


  var _useState5 = react.useState(false),
      _useState6 = _slicedToArray(_useState5, 2),
      switchs = _useState6[0],
      setSwitchs = _useState6[1];

  var _useState7 = react.useState(null),
      _useState8 = _slicedToArray(_useState7, 2),
      odDom = _useState8[0],
      setOdDom = _useState8[1]; // 之前的dom；


  var _useState9 = react.useState(false),
      _useState10 = _slicedToArray(_useState9, 2),
      stata = _useState10[0],
      setStata = _useState10[1];
  ...
  react.useEffect(function () {
    if (path) {
      ...
      if (!odDom) {
        setOdDom(jsx(reactRouterDom.Route, {
          component: component
        }));
      }
      ...
      if (index === 0) {
        ...
        var odList = _toConsumableArray(pathNameList);
      ...
      index += 1;
      newDom = jsx(reactRouterDom.Route, {
        component: component
      });
  ...
  if (path) {
    return jsx("div", {
      className: "".concat(switchs && states === '上一次操作路由返回' ? 'zoomLeft' : switchs && states === '上一次操作路由向下' ? 'zoomRight' : ''),
      style: {
        position: 'absolute',
        top: '0',
        left: "".concat(switchs && states === '上一次操作路由返回' ? '-100%' : '0'),
...
exports.ReactRouterTransitionPage = ReactTransitionGroup;
